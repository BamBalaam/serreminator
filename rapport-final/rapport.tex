...
\section{Détermination des paramètres de PID} %TODO: refactor intro
...
Le principe est de générer une population de chromosomes, des êtres virtuels qui possèdent tous ici 3 emplacements, représentant chacun l'un des paramètres Kp, Ki ou Kd à déterminer.
...
À la fin de toutes ces itérations, le meilleur dernier chromosome sera sélectionné en fonction de son score: ses paramètres seront
