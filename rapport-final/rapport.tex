...
\begin{enumerate}
\item la stabilité (),
\item la précision (la tendance à rester autour de ),
...
\section{Comparaison des résultats de BangBang et P/PI/PID}
...
Bien que son score soit le meilleur, il reste le plus difficile à mettre en oeuvre: il nécessite la détermination de ses trois paramètres.
