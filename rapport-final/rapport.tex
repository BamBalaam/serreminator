...
\begin{itemize}
    ...
    \item L'algorithme de contrôle est lancé avec comme consigne de stabiliser le système à 1000 lux.
    \item 20 secondes après, la simulation est arrêtée.
...
\end{table}
\footnotetext{Le résultat obtenu ici est différent du résultat obtenu dans le tableau~\ref{tab:methode} car les simulations ici n'ont pas la même durée que dans le tableau précédent.}
