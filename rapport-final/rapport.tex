...
De plus, cet algorithme ne permet pas une stabilité suffisante pour certains phénomènes: en effet, une fois la correction atteinte, \emph{bang bang} n'agira plus jusqu'à ce que les pertubations ne s'accumulent trop. \cite{Burghes2004245} % TODO : double citation en 2§
