...
% TODO : c'est pas du tout le rôle PID a le même rôle que tous les régultateurs : s'apporcher le plus possible de la consigne
...
\subsection{Tabu}
=======
\cite{thomas2009position} a réalisé une comparaison des performances obtenues entre un PID paramétré via la méthode de Ziegler-Nichols et via un algorithme génétique et a montré un temps de réponse beaucoup plus rapide avec cet algorithme.

\subsection{Tabu}
>>>>>>> e25fb6e6fbf829f007566ee49c04cb4862f4be39
\cite{bagis2011tabu}
