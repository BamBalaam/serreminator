...
\begin{center}
    \begin{tabular}{|l|l|}
        ...
        Ziegler-Nichols\footnotemark & $3,91 \cdot 10^4$\\ \hline
...
\end{table}
\footnotetext{Le résultat obtenu ici est différent du résultat obtenu dans le tableau~\ref{tab:methode} car les simulations n'ont pas été lancées dans la même batterie de test.} 
...
En effet, pour des phénomènes rémanents ou tels que la diffusion de chaleur, Bang Bang est amplement suffisant tant que leur inertie n'est pas trop grande.
